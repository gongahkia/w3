...
export async function extractFilmsWe(url) {
...
// extractFilms(`https://www.wecinemas.com.sg/buy-ticket.aspx?movieid=&date=07/26/2024`).then((weFilmsObject) => {
//     if (weFilmsObject) {
...
// extractFilms(`https://www.wecinemas.com.sg/buy-ticket.aspx?movieid=&date=${getCurrentDate()}`).then((weFilmsObject) => {
//     if (weFilmsObject) {
//         console.log(JSON.stringify(weFilmsObject, null, 2));
//     } else {
//         console.log('no movies data were found');
