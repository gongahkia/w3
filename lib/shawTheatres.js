...
// SHAW THEATRES SCRAPER

// - parses data from https://shaw.sg/movie

// ~~~ fua ~~~
    // - this api MIGHT do what i want (https://github.com/PopcornData/shaw-scraper) so check it out but MUST use Python to interact with it
...
async function extractFilmsShaw(url) {
...
module.exports = { extractFilmsShaw };

// ----- EXECUTION CODE -----

extractFilmsShaw("https://shaw.sg/Showtimes/2024-07-24/All/All");