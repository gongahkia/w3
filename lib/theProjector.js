...
async function extractFilmsTp(url) {
    ...
    if (htmlText) {
        ...
        if (projFilms.length) {
            ...
            console.log(`number of tp movies => ${projFilmsObject.length}`);
...
module.exports = { extractFilmsTp };

// ----- EXECUTION CODE -----
    // - for testing
    // - actual usage to be called from /src/main.js

// extractFilmsTp("https://theprojector.sg/films").then((projFilmsObject) => {
//     if (projFilmsObject) {
